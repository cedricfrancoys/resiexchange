...
var PLIGG_Visual_Vote_Like = '{#PLIGG_Visual_Vote_Like#}';
var PLIGG_Visual_Vote_UnLike = '{#PLIGG_Visual_Vote_UnLike#}';
		...
		if (data.match (new RegExp ("^ERROR:"))) {
			...
			anchor.addClass(value>0 ? 'btn-success' : 'btn-danger')
		     ...
		     if(value==10){
			  ...
			  like_dislike_text=PLIGG_Visual_Vote_Like;
...
function unvote (user, id, htmlid, md5, value)
{
    ...
    if (!anonymous_vote && user== "") {
		...
		if (data.match (new RegExp ("^ERROR:"))) {
			...
			if(value==10)
			  like_dislike_text=PLIGG_Visual_Vote_UnLike;
			 else if(value==-10)
