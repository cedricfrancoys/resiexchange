...
<form action="story.php?title={$link_title_url}" method="post" id="thisform" name="mycomment_form">
<div class="form-horizontal">
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea name="comment_content" id="comment_content" data-provide="markdown" rows="25" />{if isset($TheComment)}{$TheComment}{/if}</textarea>
