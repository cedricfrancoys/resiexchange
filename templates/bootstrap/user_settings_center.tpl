			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
                            <input type="text" class="form-control" name="email" id="email" tabindex="3" value="{$user_email}">
							<div class="help-inline">{#PLIGG_Visual_Profile_OnlyAdmins#}</div>
                        </td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
                            <input type="text" class="form-control" name="url" id="url" tabindex="7" value="{$user_url}">
                        </td>
					</tr>
					<tr>
