...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/bootstrap.min.css">    
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/bootstrap-theme.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/bootstrap-markdown.min.css">    
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/jqueryui/themes/smoothness/jquery-ui.min.css" media="all"  />    
	...
	<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/select2.min.css" media="screen" />    
	{if $Voting_Method eq 2}
		<link rel="stylesheet" type="text/css" href="{$my_pligg_base}/templates/{$the_template}/css/star_rating/star.css" media="screen" />
	{/if}
    
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/markdown.js"></script>
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/to-markdown.js"></script>        
	...
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/bootstrap-markdown.js"></script>    
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/select2.min.js"></script>        


	
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/modernizr.js"></script>	

    <script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery-ui.min.js"></script>
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery.pnotify.min.js"></script>
	<script type="text/javascript" src="{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery.hotkeys.js"></script>
		...
		$(function()
		{
            ...
            $("#tags").on('change', function() {
                ...
                $.each(tags, function(i, tag) {
                    if(txt.length > 0) txt += ', ';
                    txt += tag.substr(tag.lastIndexOf('/')+1);
                });
				$(".tags").html(txt);
				return false;
			});
						...
						<div class="control-group">
							<form id="signin" action="{$URL_login}" method="post">
								...
								<div style="login_modal_username">
									<label for="username">{#PLIGG_Visual_Register_Email#}</label>
