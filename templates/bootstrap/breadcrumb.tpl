					...
					<ul class="dropdown-menu" id="menu1">
						{if $pagename eq "published" || $pagename eq "index" || $pagename eq "new" || $pagename eq "search"}
							...
							{if $setmeka eq "" || $setmeka eq "recent"}
								<li id="active"><a id="current" href="{$index_url_recent}"><span class="active">{#PLIGG_Visual_Sort_Recent#}</span></a></li>
							{else}
								<li><a href="{$index_url_recent}">{#PLIGG_Visual_Sort_Recent#}</a></li>
							{/if}
