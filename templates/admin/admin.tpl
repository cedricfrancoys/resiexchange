...
<head>
    ...
    <script type="text/javascript" src="{$my_base_url}{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery.min.js"></script>
	<script type="text/javascript" src="{$my_base_url}{$my_pligg_base}/templates/{$the_template}/js/jquery/jquery-ui.min.js"></script>
